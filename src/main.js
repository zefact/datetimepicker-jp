import JapaneseHolidays from '@zefact/jp-holidays';
...
(function ($) {
  ...
  DateTimePicker.prototype = {
    ...
    init: function (element, options) {
      ...
      this.language = options.language in dates ? options.language : 'ja';
    ...
    fillDate: function () {
      ...
      while (prevMonth.valueOf() < nextMonth) {
        ...
        if (JapaneseHolidays.isHoliday(prevMonth)) {
          clsName += ' holiday';
        }
          ...
          switch (target[0].nodeName.toLowerCase()) {
            ...
            case 'td':
              if (target.is('.day')) {
                ...
                this.set();
                this.notifyChange();
                if (this.autoHide) this.widget.hide();
              }
              break;
          }
        }
    ...
    _attachDatePickerEvents: function (e) {
      var self = this;
